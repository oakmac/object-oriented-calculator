...
radio1.frequency('fm', 104.9) // set the frequency

radio1.getFrequency()
radio1.setFrequency('fm', 97.9)
radio1.setFrequency('am', 1560)

// NOTE:
// - FM stations must be between 88 and 108
// - AM stations must be between 540 and 1600
